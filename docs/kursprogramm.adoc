...
* *Hintergrundild (Wallpaper):* Das Bild, das den Desktop ziert
...
[NOTE]
====
Das Mausrad: Drehen Sie das Rad nach vorne, um nach oben zu scrollen, nach hinten für nach unten.
====
...
. Klicken Sie auf *Brief.txt*, um es in der Vorschau zu öffnen.
